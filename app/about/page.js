    ...
    <main className="container mx-auto px-4 py-8">
      ...
      >
        ...
        <div className="relative z-10 bg-white bg-opacity-80 p-8 rounded-lg">
          <h1 className="text-4xl font-bold mb-4 text-[#1C74BB]">About Spring of Knowledge Academy</h1>
...
<section className="mb-16">
 <h2 className="text-3xl font-semibold mb-8 text-center text-[#1C74BB]">Our Core Values</h2>
  <div className="grid grid-cols-1 md:grid-cols-2 gap-10 justify-items-center">
    <div className="space-y-6">
      {values.slice(0, 3).map((value, index) => (
        ...
        >
          <Card className="h-full transition-all duration-300 hover:shadow-lg hover:bg-[#111827] hover:text-[#1C74BB] group">
            <CardContent className="flex flex-col items-center p-6 h-64 justify-between">
              <div className="flex flex-col items-center mt-5 mb-auto">
                <div className="text-[#1C74BB] group-hover:text-white mb-4">
                  {value.icon}
                </div>
