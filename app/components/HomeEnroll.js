  ...
  return (
    <section className="relative h-[600px] w-full overflow-hidden bg-black">
      ...
      <div className="container mx-auto text-center relative z-10 h-full flex flex-col justify-center items-center">
        ...
        <Link href="/contact">
          <button className="shadow-[0_4px_14px_0_rgb(0,0,0,10%)] hover:shadow-[0_6px_20px_rgba(93,93,93,23%)] px-8 py-2 bg-[#fff] text-[#696969] hover:text-white hover:bg-[#18BEBC] rounded-md font-light transition duration-200 ease-linear">
            Enroll Today
          </button>
        </Link>
      </div>
